...
//	        log.error(ex.getMessage());
	...
	public final ResponseEntity<ExceptionResponse> handleNotFoundException(OrdersNotFoundException ex,
			WebRequest request) {
...
//	        log.error(ex.getMessage());
	...
	public final ResponseEntity<ExceptionResponse> handleNotFoundException(AddressNotFoundException ex,
			WebRequest request) {
...
//	        log.error(ex.getMessage());
	...
	protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
		...
		ExceptionResponse response = new ExceptionResponse(LocalDate.now(), details.toString(),
